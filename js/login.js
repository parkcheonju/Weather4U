  ...
  $("input").blur(function () {
    ...
    if ($(this).hasClass("name")) {
      if ($(this).val().length === 0) {
        $(this).siblings("span.error").text("Please type your Nick name").fadeIn().parent(".form-group").addClass("hasError");
        usernameError = true;
      } else if ($(this).val().length > 0 && $(this).val().length <= 1) {
        $(this).siblings("span.error").text("Please type at least 2 characters").fadeIn().parent(".form-group").addClass("hasError");
        usernameError = true;
      } else {
